...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_prefix",type=str,default="",help="the exact name of one dataset you want to use")
    ...
    folders_with_prefix = [folder for folder in os.listdir(source)
                       if folder.startswith(prefix) and os.path.isdir(os.path.join(source, folder))]
    for speaker in tqdm(folders_with_prefix):
